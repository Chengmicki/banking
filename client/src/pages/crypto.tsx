          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <span className={`text-sm ${portfolioChange.percentage >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                  ${portfolioChange.value.toFixed(2)} ({portfolioChange.percentage >= 0 ? '+' : ''}{portfolioChange.percentage.toFixed(2)}%) today
                </span>
              </div>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  {amount && (
                    <p className="text-xs text-gray-500">
                      ≈ {(parseFloat(amount) / getCurrentPrice(selectedCrypto)).toFixed(8)} {selectedCrypto}
                    </p>
                  )}
                </div>
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {supportedCryptos.map((crypto) => {
              ...
              return (
                <div key={crypto.symbol} className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
